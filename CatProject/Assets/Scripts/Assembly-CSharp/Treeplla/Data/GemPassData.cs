...
namespace Treeplla.Data
{
	public struct GemPassData : IFlatbufferObject
	{
		...
		{
			return GetRootAsGemPassData(_bb, new GemPassData());
		}
		...
		public static Offset<GemPassData> EndGemPassData(FlatBufferBuilder builder)
		{
			...
			return new Offset<GemPassData>(o);
		}

		public GemPassDataT UnPack()
		{
			var _o = new GemPassDataT();
			UnPackTo(_o);
			return _o;
		}
		...
		{
			if (_o == null) return default(Offset<GemPassData>);
