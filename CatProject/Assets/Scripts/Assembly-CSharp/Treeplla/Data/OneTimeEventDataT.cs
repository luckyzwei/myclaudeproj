...
{
	public class OneTimeEventDataT
	{
		[JsonProperty("idx")]
		...
		[JsonProperty("companyresetcount")]
		public int Companyresetcount { get; set; }

		[JsonProperty("companyresettime")]
		public long Companyresettime { get; set; }
