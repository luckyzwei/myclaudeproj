...
public class HintDoublePointingPairsDoubleQueen : BaseHint
{
	[SerializeField]
	...
	private HashSet<int> m_rowsWithQueens;

	private HashSet<int> m_columnsWithQueens;
	...
	private bool HasQueens(List<int> rows, bool isColumn)
	{
		return false;
	}

	private void GetColorsWithQueens()
	{
	}
