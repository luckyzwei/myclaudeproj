...
{
	[AnalyticsEvent("stage_failed", "An event for tracking how many times particular stage is failed.")]
	public class StageFailedEvent : AnalyticEvent
	{
		...
		public StageFailedEvent(int levelValue, string levelId, int stageValue, string stageId, string attemptId)
			: base(null)
		{
		}
	}
