...
{
	[AnalyticsEvent("level_completed", "An event for tracking how many times particular level is failed. This event is used to determine what level the player is on at any given time.")]
	public class LevelCompletedEvent : AnalyticEvent
	{
		...
		public LevelCompletedEvent(int levelValue, string levelId, string attemptId)
			: base(null)
		{
		}
	}
